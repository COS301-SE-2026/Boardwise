...
@ActiveProfiles("test")
// Testcontainers provides a real MongoDB so MongoTemplate and all repositories
// wire correctly without hitting localhost:27017 with credentials.
@Testcontainers
class ProfileControllerTest {
        ...
        void setUp() throws ServletException, IOException {
                // Make the JWT filter a no-op so requests are never blocked by it
                doAnswer(invocation -> {
                ...
                mockProfileResponse = new ProfileResponseDTO(
                                "Test User", testUsername, "https://r2.example.com/profile.jpg",
        ...
        @Test
        @WithMockUser
        void shouldReturn400_WhenNoTokenForOwnProfile() throws Exception {
                // extractToken() throws IllegalArgumentException("Missing or invalid JWT
                // token")
                // before the try block in getOwnProfile. GlobalExceptionHandler catches
        ...
        void shouldReturn500_WhenDeleteFails() throws Exception {
                ...
                mockMvc.perform(delete("/api/users/")
                                ...
                                .andExpect(jsonPath("$.message").value(
                                                "Failed to delete account. Something went wrong on our side."));
        }
        ...
        void shouldUpdateProfilePicture_Successfully() throws Exception {
                MockMultipartFile profilePic = new MockMultipartFile(
                                "profilePicture", "avatar.jpg", "image/jpeg",
                                "test image content".getBytes());

                ProfilePictureResponseDTO picResponse = new ProfilePictureResponseDTO(
                                "Profile picture successfully update",
                                "https://r2.example.com/testuser/avatar.jpg");
        ...
        @Test
        @WithMockUser
        void shouldReturn500_WhenProfilePictureUploadFails() throws Exception {
        ...
        void shouldUpdatePreferences_WithNullGenres() throws Exception {
                ...
                Map<String, Object> prefResponse = new HashMap<>();
                prefResponse.put("message", "Preferences updated successfully.");
                prefResponse.put("preferences", Map.of("isPrivate", true, "genres", List.of()));
