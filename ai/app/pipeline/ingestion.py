...
def run_ingestion_pipeline(
    ...
    try:
        ...
        extract_success, extracted_text, cover_bytes = extract_text_and_cover(file_bytes)

        if not extract_success or cover_bytes is None:
        ...
        cover_upload = r2_service.upload_to_r2(cover_bytes, cover_key, content_type="image/png")
