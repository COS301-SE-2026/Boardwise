...
export const useLibrary = () => {
    ...
    const getAllRulebooks = async () => {
        ...
        try {
            ...
            rulebooks.value = response.content.map((rulebook: any) => ({
                ...rulebook,
    ...
    const getRulebookById = async (id: string) => {
        ...
        try{
            ...
            currentRulebook.value = {
                ...rawData,
                title: rawData.gameName,
                // description: rawData.description | "",
                // genre: rawData.genre || "All",
            }
        }catch(err: any){
    ...
    const getRulebookText = async (id: string) => {
        try {
            ...
            rulebookText.value.chunks = [response.content];
        } catch (err: any) {
